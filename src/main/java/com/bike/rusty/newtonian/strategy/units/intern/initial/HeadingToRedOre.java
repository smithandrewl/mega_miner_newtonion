...
public class HeadingToRedOre implements State<GameData> {
    private final Tile targetTile;
    private final Intern intern;
    private final List<Tile> pathToTile;
    private StateMachine<GameData> stateMachine;
    private static Logger LOGGER = Logger.getLogger(HeadingToRedOre.class.getName());
    ...
    public void entering(GameData data) {
        LOGGER.info(String.format("Intern %s Entering Heading To Red Ore State", intern.getId()));
